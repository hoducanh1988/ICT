...
namespace AgilentE3632A
{
    public class Power : IPowerSupply {
        ...
        public int Remote() {
            return device.WriteLine("SYSTem:REMote") == true ? 0 : 1;
        }

        public int Wait() {
            return device.WriteLine("*WAI") == true ? 0 : 1;
        }

        public string get_Device_Status() {
            return device.Query("*OPC?").Replace("\r", "").Replace("\n", "").Trim();
        }
        ...
        public int set_Current_Protection_Level(double value) {
            return device.WriteLine(string.Format("CURRent:PROTection:LEVel {0}", value)) == true ? 0 : 1;
        ...
        public int set_Current_Protection_State(bool flag) {
            ...
            return device.WriteLine(string.Format("CURRent:PROTection:STATe {0}", target)) == true ? 0 : 1;
        ...
        public int set_Output_State(bool flag) {
            string target = flag == true ? "1" : "0";
            return device.WriteLine(string.Format("OUTPut:STATe {0}", target)) == true ? 0 : 1;
        ...
        public int set_Output_On() {
            return device.WriteLine("OUTPut:STATe 1") == true ? 1 : 0;
        }

        public int set_Output_Off() {
            return device.WriteLine("OUTPut:STATe 0") == true ? 1 : 0;
        }

        public int set_Output_Value(double volt, double current) {
            return device.WriteLine(string.Format("APPLy {0},{1}", volt, current)) == true ? 0 : 1;
        ...
        public int set_Voltage_Protection_Level(double value) {
            return device.WriteLine(string.Format("VOLTage:PROTection:LEVel {0}", value)) == true ? 0 : 1;
        ...
        public int set_Voltage_Protection_State(bool flag) {
            string target = flag == true ? "1" : "0";
            return device.WriteLine(string.Format("VOLTage:PROTection:STATe {0}", target)) == true ? 0 : 1;
        ...
        public int set_Voltage_Range(double value) {
            ...
            return device.WriteLine(string.Format("VOLTage:RANGe {0}", target)) == true ? 0 : 1;
